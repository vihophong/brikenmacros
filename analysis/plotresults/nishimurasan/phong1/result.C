...
void result() 
{
  ...
  for (Int_t i=0; i<17; i++) {
    ...
    //        hexp1->Fill(data_n[i], data_p[i], 1/(qrpa1_p1n[i]/data_p1n[i]));
    //        hexp2->Fill(data_n[i], data_p[i], 1/(qrpa2_p1n[i]/data_p1n[i]));
    //        hexp3->Fill(data_n[i], data_p[i], 1/(qrpahf_p1n[i]/data_p1n[i]));
    //        hexp4->Fill(data_n[i], data_p[i], 1/(d3c_p1n[i]/data_p1n[i]));
    //        hexp5->Fill(data_n[i], data_p[i], 1/(mie_p1n[i]/data_p1n[i]));


    //        hexp0->Fill(data_n[i], data_p[i], data_p2n[i]);
    //        hexp1->Fill(data_n[i], data_p[i], 1/(qrpa1_p2n[i]/data_p2n[i]));
    //        hexp2->Fill(data_n[i], data_p[i], 1/(qrpa2_p2n[i]/data_p2n[i]));
    //        hexp3->Fill(data_n[i], data_p[i], 1/(qrpahf_p2n[i]/data_p2n[i]));
    //        hexp4->Fill(data_n[i], data_p[i], 1/(d3c_p2n[i]/data_p2n[i]));
    //        hexp5->Fill(data_n[i], data_p[i], 1/(mie_p2n[i]/data_p2n[i]));
  ...
  //    Double_t mymin = 0;   Double_t mymax = 100;  //p1n
    Double_t mymin = 0;   Double_t mymax = 90;  //p2n
