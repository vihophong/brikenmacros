...
#include "/home/phong/briken17/brikenmacrosupdate/brikenmacros/fitting/pgenfit/pgenfitv4/include/fitF.hh"
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::fitF*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("fitF", ::fitF::Class_Version(), "include/fitF.hh", 23,
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::fitF*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::fitFbkg*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("fitFbkg", ::fitFbkg::Class_Version(), "include/fitF.hh", 50,
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::fitFbkg*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
TClass *fitF::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::fitF*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::fitFbkg*)0x0)->GetClass(); }
   return fgIsA;
}
...
"/home/phong/briken17/brikenmacrosupdate/brikenmacros/fitting/pgenfit/pgenfitv4/include/fitF.hh",
0
    };
...
"/home/phong/root_v6.14/include",
"/data01/usersdata/phong/projects/briken/briken17/brikenmacrosupdate/brikenmacros/fitting/pgenfit/benchmarkPgenfitv4/build-penfit/",
0
    };
...
class __attribute__((annotate(R"ATTRDUMP(Your description goes here...)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$/home/phong/briken17/brikenmacrosupdate/brikenmacros/fitting/pgenfit/pgenfitv4/include/fitF.hh")))  fitF;
class __attribute__((annotate(R"ATTRDUMP(Your description goes here...)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$/home/phong/briken17/brikenmacrosupdate/brikenmacros/fitting/pgenfit/pgenfitv4/include/fitF.hh")))  fitFbkg;
)DICTFWDDCLS";
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libfitF",
        ...
        TriggerDictionaryInitialization_libfitF_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
