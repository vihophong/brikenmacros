...
void ploteffaddback(Double_t inpute)
{
    ...
    TF1* efffall[2];
    TFile *_file0 = TFile::Open("hab1_curve.root");

    TGraphErrors* gr0=(TGraphErrors*)_file0->Get("Graph");
    grall[0]=(TGraphErrors*) gr0->Clone();
    efffall[0]=(TF1*)_file0->Get("fnc_eff");
    TFile *_file1 = TFile::Open("hab2_curve.root");
    TGraphErrors* gr1=(TGraphErrors*)_file1->Get("Graph");
    ...
    */
    ...
    TGraphErrors* grpntsum=new TGraphErrors(16,pntsum,pntsumeff,0,pntsumefferr);
    grpntsum->SetMarkerSize(1.2);
    grpntsum->SetMarkerStyle(20);
    grpntsum->SetLineColor(1);
    grpntsum->SetLineWidth(1);
    ...
    grpntsum->Write();
    fcnsum->SetName("fab_fit");
    fcnsum->Write();
    f0->Close();
}


void ploteffgcdirectfit(Double_t inpute)
{
    Double_t norm[2];
    TGraphErrors* grall[2];
    TF1* efffall[2];
    TFile *_file0 = TFile::Open("hgc1_curve.root");

    TGraphErrors* gr0=(TGraphErrors*)_file0->Get("Graph");
    grall[0]=(TGraphErrors*) gr0->Clone();
    efffall[0]=(TF1*)_file0->Get("fnc_eff");
    TFile *_file1 = TFile::Open("hgc2_curve.root");
    TGraphErrors* gr1=(TGraphErrors*)_file1->Get("Graph");
    grall[1]=(TGraphErrors*) gr1->Clone();
    efffall[1]=(TF1*)_file1->Get("fnc_eff");
