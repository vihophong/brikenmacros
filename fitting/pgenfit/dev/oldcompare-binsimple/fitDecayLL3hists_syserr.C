...
//! Global function
Double_t fcn_gen_wneutronnuc1(Double_t *x, Double_t *par) {
    Double_t randcoinfgt0n=par[knri*2+4];
    Double_t randcoinf1n=par[knri*2+3];
    Double_t bkg=par[knri*2+2];
    if (x[0]<0) return bkg;
...
//! Global function
Double_t fcn_gen_wneutron_des(Double_t *x, Double_t *par) {
    Double_t randcoinfgt0n=par[knri*2+4];
    Double_t randcoinf1n=par[knri*2+3];
    Double_t bkg=par[knri*2+2];
    if (x[0]<0) return bkg;
...
void fitDecayLL3hists_wrndcoin(char* fitname,char* infile,char* parmsfile, Int_t ninterations, char* outfile,Double_t irejectrange=0.05, Int_t rebin=1,Double_t neutronefficiency=0.62,Double_t neutronefficiency_err=0.053,Double_t nimplants=1){
    ...
    parmsmin[knri*2+6]=0;
    parmsmin[knri*2+7]=0;
    isparmsfix[knri*2+5]=1;
    isparmsfix[knri*2+6]=1;
    isparmsfix[knri*2+7]=1;
...
*/
    ...
    parmserr[knri*2+1]=parms[knri*2+1]*bkgactmaxmin;
    ...
    */
    ...
    fSB->SetParameter(knri*2+3,parms[knri*2+5]);//random coincidence factor
    fSB->SetParLimits(knri*2+3,0.,1.);//random coincidence factor
    fSB->SetParameter(knri*2+4,parms[knri*2+6]);//random coincidence 2 neutron factor
    ...
    fSB2->SetParameter(knri*2+3,parms[knri*2+5]);//random coincidence factor
    fSB2->SetParLimits(knri*2+3,0.,1.);//random coincidence factor

    fSB2->SetParameter(knri*2+4,parms[knri*2+6]);//random coincidence 2 neutron factor
    fSB2->SetParLimits(knri*2+4,0.,1.);//random coincidence 2 neutron factor

    fSB2->SetParameter(knri*2+5,parms[knri*2+7]);//random coincidence 3 neutron factor
   ...
   for (int i=0;i<knri*2+8;i++){
       if (parmserr[i]==0||isparmsfix[i]){
          ...
          cout<<"variable value p"<<i<<"\tval "<<parms[i]<<"\tmin="<<fitter.Config().ParSettings(i).LowerLimit()<<"\tmax="<<fitter.Config().ParSettings(i).UpperLimit()<<endl;
       }
   }
...
/*
   ...
   */
   ...
   TF1* fbBdes=new TF1("fbBdes",fcn_gen_des,plotrange[0],plotrange[1],knri*2+3);

   TF1* fbBnuc1=new TF1("fbBnuc1",fcn_gennuc1,plotrange[0],plotrange[1],knri*2+3);
   TF1* fbBnuc2=new TF1("fbBnuc2",fcn_gennuc2,plotrange[0],plotrange[1],knri*2+3);
   TF1* fbBnuc3=new TF1("fbBnuc3",fcn_gennuc3,plotrange[0],plotrange[1],knri*2+3);
   TF1* fbBnuc4=new TF1("fbBnuc4",fcn_gennuc4,plotrange[0],plotrange[1],knri*2+3);
   TF1* fbBnuc5=new TF1("fbBnuc5",fcn_gennuc5,plotrange[0],plotrange[1],knri*2+3);
   TF1* fbBnuc6=new TF1("fbBnuc6",fcn_gennuc6,plotrange[0],plotrange[1],knri*2+3);
   TF1* fbBnuc9=new TF1("fbBnuc9",fcn_gennuc9,plotrange[0],plotrange[1],knri*2+3);
   TF1* fBcbkg=new TF1("fBcbkg",fcn_gen_bkg,plotrange[2],plotrange[0],knri*2+3);

   TF1* fbSBnuc1=new TF1("fbSBnuc1",fcn_gen_wneutronnuc1,plotrange[0],plotrange[1],knri*2+5);
   TF1* fbSBdes=new TF1("fbSBdes",fcn_gen_wneutron_des,plotrange[0],plotrange[1],knri*2+5);

   TF1* fSBc1=new TF1("fSBc1",fcn_gen_wneutronc1,plotrange[0],plotrange[1],knri*2+5);
   TF1* fSBc2=new TF1("fSBc2",fcn_gen_wneutronc2,plotrange[0],plotrange[1],knri*2+5);
   TF1* fSBc3=new TF1("fSBc3",fcn_gen_wneutronc3,plotrange[0],plotrange[1],knri*2+5);
   TF1* fSBcbkg=new TF1("fSBcbkg",fcn_gen_wneutron_bkg,plotrange[2],plotrange[0],knri*2+5);

   TF1* fSB2c1=new TF1("fSB2c1",fcn_gen_w2neutronc1,plotrange[0],plotrange[1],knri*2+6);
   TF1* fSB2c2=new TF1("fSB2c2",fcn_gen_w2neutronc2,plotrange[0],plotrange[1],knri*2+6);
   TF1* fSB2c3=new TF1("fSB2c3",fcn_gen_w2neutronc3,plotrange[0],plotrange[1],knri*2+6);
   TF1* fSB2c4=new TF1("fSB2c4",fcn_gen_w2neutronc4,plotrange[0],plotrange[1],knri*2+6);
   TF1* fSB2cbkg=new TF1("fSB2cbkg",fcn_gen_w2neutron_bkg,plotrange[2],plotrange[0],knri*2+5);
   ...
   for (Int_t i=0;i<knri*2+5;i++){
	   ...
	   fBcbkg->FixParameter(i,fB->GetParameter(i));
	   fbBdes->FixParameter(i,fB->GetParameter(i));
       ...
       fbSBdes->FixParameter(i,fSB->GetParameter(i));
       fbSBnuc1->FixParameter(i,fSB->GetParameter(i));
   ...
   fbBdes->SetLineColor(3);
   fbBdes->Draw("same");
   fBcbkg->SetLineColor(kBlue);
   fBcbkg->Draw("same");
   fbBnuc1->SetLineColor(kMagenta);
   fbBnuc1->Draw("same");
   ...
   histcomphB->SetMarkerStyle(20);
   histcomphB->SetMarkerSize(0.5);
   histcomphB->GetXaxis()->SetLabelSize(0.08);
   histcomphB->GetYaxis()->SetLabelSize(0.08);
   histcomphB->Draw("P0L");
   ...
   hSB->SetMarkerSize(0.5);
   hSB->GetXaxis()->SetLabelSize(0.08);
   hSB->GetYaxis()->SetLabelSize(0.08);
   hSB->Draw("P0 E");

   fbSBdes->SetLineColor(3);
   fbSBdes->Draw("same");
   fSBcbkg->SetLineColor(kBlue);
   fSBcbkg->Draw("same");
   fbSBnuc1->SetLineColor(kMagenta);
   fbSBnuc1->Draw("same");
   //fbSBnuc1->SetLineColor(kMagenta);
   //fbSBnuc1->Draw("same");
   ...
   histcomphSB->SetMarkerStyle(20);
   histcomphSB->SetMarkerSize(0.5);
   histcomphSB->GetXaxis()->SetLabelSize(0.08);
   histcomphSB->GetYaxis()->SetLabelSize(0.08);
   histcomphSB->Draw("P0L");
   ...
   hSB2->SetMarkerSize(0.5);
   hSB2->GetXaxis()->SetLabelSize(0.08);
   hSB2->GetYaxis()->SetLabelSize(0.08);
   hSB2->Draw("P0 E");

   fSB2cbkg->SetLineColor(kBlue);
   fSB2cbkg->Draw("same");
   ...
   histcomphSB2->SetMarkerStyle(20);
   histcomphSB2->SetMarkerSize(0.5);
   histcomphSB2->GetXaxis()->SetLabelSize(0.08);
   histcomphSB2->GetYaxis()->SetLabelSize(0.08);
   histcomphSB2->Draw("P0L");
