...
// Fri Jun 23 22:08:55 2017 by ROOT version 5.34/36
// from TTree tree/tree
// found on file: outfileAll.root
//////////////////////////////////////////////////////////
...
public :
   ...
   virtual void     Loop(Int_t dssd, Double_t ecut, Int_t npoint, char *outname, Int_t startch=0,Int_t stopch=16384);
   virtual Bool_t   Notify();
   virtual void     Show(Long64_t entry = -1);

   virtual void     CheckCalib(char* calibfile, char *outfilename);
};
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("outfileAllAll.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("outfileAllAll.root");
      }
