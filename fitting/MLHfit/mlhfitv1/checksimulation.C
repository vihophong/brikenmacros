...
void checksimulation()
{
    ...
    TH1F* hdecayconly1neub=new TH1F("hdecay1nbwd","hdecayconly1neub",2000,-windowlow/1,windowup/1);

    TH1F* hdecayconly2neu=new TH1F("hdecayconly2neu","hdecayconly2neu",2000,-windowlow/1,windowup/1);
    TH1F* hdecayconly2neub=new TH1F("hdecay2nbwd","hdecayconly2neub",2000,-windowlow/1,windowup/1);


    TH1F* hdecaycmorethan0neu=new TH1F("hdecaycmorethan0neu","hdecaycmorethan0neu",2000,-windowlow/1,windowup/1);
    TH1F* hdecaycmorethan0neub=new TH1F("hdecaygt0nbwd","hdecaycmorethan0neub",2000,-windowlow/1,windowup/1);
