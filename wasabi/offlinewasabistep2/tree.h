...
public :
   ...
   Double_t           dssd_bl[N_DSSD*(N_STRIP_X+N_STRIP_Y)];
   Int_t           dssd_ch[N_DSSD*(N_STRIP_X+N_STRIP_Y)];


   Double_t           dssd_EX[N_DSSD];
   Double_t           dssd_EY[N_DSSD];
   Int_t          dssd_NX[N_DSSD];
   Int_t           dssd_NY[N_DSSD];
   Int_t           dssd_No[N_DSSD];
   ...
   tree(TChain* chain,TTree *tree1=0);
   virtual ~tree();
