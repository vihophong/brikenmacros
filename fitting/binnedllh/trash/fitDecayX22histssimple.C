...
void fitDecayX22histssimple(char* fitname,char* infile,char* parmsfile, Int_t ninterations, char* outfile, Int_t entrybegin, Int_t nentries, Int_t binning=2000){
   ...
   */
   ...
   for(int i=0;i<ninterations;i++) {
       ...
       fitter.FitFCN(knri*2+5,globalChi2,0,dataB.Size()+dataSB.Size(),true);
