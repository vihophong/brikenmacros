...
// Fri Apr 26 18:56:07 2019 by ROOT version 6.08/00
// from TTree BRIKEN/BRIKEN
// found on file: tempHist0.root
//////////////////////////////////////////////////////////
...
#ifdef countn_cxx
countn::countn(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tempHist0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("tempHist0.root");
      }
...
Int_t countn::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t countn::LoadTree(Long64_t entry)
{
...
void countn::Show(Long64_t entry)
{
...
Int_t countn::Cut(Long64_t entry)
{
