...
#include "tree.h"
// default constant
tree::tree(TChain* chain,TTree* tree1) : fChain(0)
{
...
// used to generate this class and read the Tree.
   ...
   for (int i=0;i<N_DSSD;i++) dssd_No[i]=i;
   //! default mapping
   Int_t strip=0;
...
void tree::ClearRecoData(){
    ...
    memset(dssd_bl,0,sizeof(dssd_bl));
    memset(dssd_EX,0,sizeof(dssd_EX));
    memset(dssd_EY,0,sizeof(dssd_EY));
    memset(dssd_NX,0,sizeof(dssd_NX));
    memset(dssd_NY,0,sizeof(dssd_NY));
     nrecodata=0;
