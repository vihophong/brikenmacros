...
void fitDecayLL3hists_wrndcoin(char* fitname,char* infile,char* parmsfile, Int_t ninterations, char* outfile,Int_t rebin=1){
   ...
   fSB2c2->SetLineColor(1);
   fSB2c3->SetLineColor(5);
   fSB2c4->SetLineColor(6);
   fSB2c1->Draw("same");
   fSB2c3->Draw("same");
   fSB2c4->Draw("same");
   fSB2c2->Draw("same");
   ...
   leg3->AddEntry(fSB2,"Total fit");
   leg3->AddEntry(fSB2c1,"Background component 1");
   leg3->AddEntry(fSB2c2,"Background component 2");
   leg3->AddEntry(fSB2c3,"Background component 3");
   leg3->AddEntry(fSB2c4,"Background component 4");
   leg3->Draw();
