...
{    
    ...
    Double_t plotrange[]={0.075,30.,-10};
    ...
    hdecay->Fit("pol1","LQRE0","goff",lowerlimit,-rejectrange);
    ...
    hdecay1n->Fit("pol1","LQRE0","goff",lowerlimit,-rejectrange);

    parms[knri*3+2]=hdecay1n->GetFunction("pol1")->GetParameter(0);
    parmserr[knri*3+2]=hdecay1n->GetFunction("pol1")->GetParError(0);
    ...
    hdecay2n->Fit("pol1","LQRE0","goff",lowerlimit,-rejectrange);

    parms[knri*3+3]=hdecay2n->GetFunction("pol1")->GetParameter(0);
    parmserr[knri*3+3]=hdecay2n->GetFunction("pol1")->GetParError(0);
