...
Bool_t reject=true;
Double_t rejectrange=0.05;//first 0.075 ms
...
void getparms(Double_t* parms,Double_t* parmserr, Double_t* parmsmax, Double_t* parmsmin, Bool_t* isparmsfix,char* infile,Double_t nsig=5.)
{
    ...
    //disabled because initial activity was provided
...
void fitDecayLL3hists_wrndcoin2(char* fitname,char* infile,char* parmsfile, Int_t ninterations, char* outfile,Int_t rebin=1){
