...
#include "/home/phong/projects/brikenmacros/merger/include/datastruct.hh"
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::fitF*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("fitF", ::fitF::Class_Version(), "include/datastruct.hh", 29,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::fitFbkg*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("fitFbkg", ::fitFbkg::Class_Version(), "include/datastruct.hh", 93,
...
"/home/phong/projects/brikenmacros/merger/include/datastruct.hh",
0
    };
...
"/opt/cernroot/root_v6.08.00/include",
"/data03/users/phong/projects/brikenmacros/build-merger-Desktop-Default/",
0
    };
...
class __attribute__((annotate(R"ATTRDUMP(Your description goes here...)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$/home/phong/projects/brikenmacros/merger/include/datastruct.hh")))  fitF;
class __attribute__((annotate(R"ATTRDUMP(Your description goes here...)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$/home/phong/projects/brikenmacros/merger/include/datastruct.hh")))  fitFbkg;
)DICTFWDDCLS";
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libdatastruct",
        ...
        TriggerDictionaryInitialization_libdatastruct_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
