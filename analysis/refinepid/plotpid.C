...
void plotPID(char* listfile,char* pidfile){
    ...
    */
    ...
    ch->Draw(Form("zet:aoq>>hpid(%d,%f,%f,%d,%f,%f)",nbinsaoq,aoqrange[0],aoqrange[1],nbinszet,zetrange[0],zetrange[1]),"zet>0&&aoq>0&&ion_z!=5&&ion_z>=0","colz");
    //ch->Draw(Form("zet:aoq>>hpid(%d,%f,%f,%d,%f,%f)",nbinsaoq,aoqrange[0],aoqrange[1],nbinszet,zetrange[0],zetrange[1]),"zet>0&&aoq>0","colz");
...
void projectpid(char* infile,Double_t Zcenter,Double_t width,char* parmsfile, char* outfile)
{
