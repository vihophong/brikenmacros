...
// Thu Aug  2 22:01:07 2018 by ROOT version 6.08/00
// from TTree anc/tree anc
// found on file: belen101.root
//////////////////////////////////////////////////////////
...
#ifdef anc_cxx
anc::anc(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/phong/data/briken2017/brikenmacros-rootfiles/analysis/belen101.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/phong/data/briken2017/brikenmacros-rootfiles/analysis/belen101.root");
      }
...
Int_t anc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anc::LoadTree(Long64_t entry)
{
